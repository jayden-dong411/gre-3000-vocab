    ...
    <div className="flex flex-col gap-5">
      <header className="flex items-start justify-between gap-4 pt-1">
        <div>
          ...
          <h1 className="mt-1 font-serif text-3xl tracking-tight text-slate-900 sm:text-4xl">
            GRE 镇考 3000
          </h1>
          <p className="mt-1.5 max-w-[20rem] text-sm leading-relaxed text-slate-500">
      ...
      <button
        type="button"
        className="self-center text-xs text-slate-400 underline-offset-4 transition hover:text-slate-600 hover:underline"
        onClick={() => {
